...
import { computePlan, computeTeardown, type Plan, type PlanAction } from "./topology/plan.ts";
      ...
      default:
        process.stderr.write(
          `Unknown command: ${command}\n` +
            `Usage: zwave-assoc <dump|plan|apply|teardown> [--file gangs.yaml] [--gang NAME] [--node ID] [--yes]\n` +
